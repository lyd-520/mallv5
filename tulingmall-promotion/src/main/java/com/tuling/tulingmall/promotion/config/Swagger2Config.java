...
public class Swagger2Config {
    ...
    public Docket createRestApi() {
        return new Docket(DocumentationType.SWAGGER_2)
                .apiInfo(apiInfo())
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.tuling.tulingmall.promotion.controller"))
    ...
    private ApiInfo apiInfo() {
        return new ApiInfoBuilder()
                .title("tuling-mall优惠券系统")
                .description("tuling-mall优惠券系统")
                .contact(new Contact("tuling-promotion",null,null))
                .version("1.0")
                .build();
    }
